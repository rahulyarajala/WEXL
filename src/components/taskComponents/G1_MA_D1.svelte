 ...
 <div class="container mt-5">
     <div class="shadow-sm  bg-white rounded">
      <div class = "bg-info rounded-top p-2">
          <h2 class = "text-center display-4 mb-0">{task02.heading}</h2>
      </div>
        ...
        <div >
            ...
            <div >   
                ...
                <table width="100">
                        ...
                        {#each task02.valueArray as col, i }                        
                            {#if i == (task02.valueArray.length - 1) }
                            <tr>
                                <td align="right"><span style="margin-right: 20px">{task02.operator}</span>{col} </td>
                            </tr>
                            {:else}
                            <tr>
